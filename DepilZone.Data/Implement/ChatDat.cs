...
namespace DepilZone.Data.Implement
{
    ...
    {
        public async Task<RespuestaDTO<ChatEnt>> Insertar(ChatEnt model)
        {
        ...
        public async Task<RespuestaDTO<ChatEnt>> Modificar(ChatEnt model)
        {
            using SqlConnection conn = DBConn.ConexionSQL();
            await conn.OpenAsync();
        ...
        static async Task<RespuestaDTO<ChatEnt>> ReadItem(DbDataReader reader)
        {
            RespuestaDTO<ChatEnt> obj = new RespuestaDTO<ChatEnt>
            {
